...
public class RolandMDX_20ControlPanelCode extends PApplet {
...
class Roland {
 ...
 public void moveWithOffset(int x,int y,int z, int offsetX, int offsetY){
    ...
    for (int i = 1; i < lines.length-1; i++) {
     // roland_port.write(lines[i+1]);
      ...
      if (lines[i].charAt(0) == 'Z') {
        ...
        sendme = "Z" + this.x + "," + this.y + "," + PApplet.parseInt(values1[2].substring(0,2)) + ";";
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "RolandMDX_20ControlPanelCode" };
    if (passedArgs != null) {
